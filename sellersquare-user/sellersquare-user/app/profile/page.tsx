        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10 text-gray-900">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 shadow-sm">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-indigo-50 border border-indigo-100/50 flex items-center justify-center shrink-0">
                    ...
                    <div className="space-y-1 min-w-0 w-full">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 pt-1 text-sm text-gray-500 font-medium">
                            {customer?.email && (
            ...
            <div className="flex pt-4 justify-start">
                <button
                    onClick={logout}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-rose-600 text-white px-5 py-3 rounded-xl font-semibold text-sm hover:bg-rose-700 active:bg-rose-800 transition shadow-sm shadow-rose-100"
                >
...
function ProfileCard({ icon, title, subtitle, onClick }: ProfileCardProps) {
    return (
        <button
            onClick={onClick}
            className="w-full bg-white border border-gray-100 rounded-2xl p-4 sm:p-5 shadow-sm hover:shadow-md hover:border-gray-200/80 transition text-left group flex items-center justify-between gap-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/10"
        >
            ...
            <ChevronRight 
                size={18} 
                className="text-gray-400 shrink-0 transition-transform duration-200 transform group-hover:translate-x-1" 
            />
        </button>
    );
}
...
function ProfilePageSkeleton() {
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10 animate-pulse space-y-6">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-6 flex flex-col sm:flex-row items-center sm:items-start gap-4">
