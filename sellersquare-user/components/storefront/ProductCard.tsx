...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group relative w-[210px] flex-shrink-0 overflow-hidden rounded-2xl border border-gray-200 bg-white transition hover:-translate-y-1 hover:border-transparent hover:shadow-lg"
    >
      <div
